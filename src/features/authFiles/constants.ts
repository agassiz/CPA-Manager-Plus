...
export const MAX_CARD_PAGE_SIZE = 600;
...
export const TYPE_COLORS: Record<string, TypeColorSet> = {
  ...
  meta: {
    light: { bg: '#e6f1ff', text: '#0867df' },
    dark: { bg: '#12366b', text: '#7db7ff' },
  },
...
export const applyCodexAuthFileSuperCategory = (
  value: Record<string, unknown>,
  superCategory: boolean
): Record<string, unknown> => {
  const next = { ...value };
  delete next.superCategory;
  if (superCategory) {
